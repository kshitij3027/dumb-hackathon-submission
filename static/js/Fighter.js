...
export const player = new Fighter({
    ...
    imageSrc: '/static/assets/img/samuraiMack/Idle.png',
    scale: 2.5,
    maxFrames: 8,
    holdFrames: 4,
    ...
    sprites: {  // Sprites for different animations.
        ...
        run: {
            imageSrc: '/static/assets/img/samuraiMack/Run.png',
            maxFrames: 8,
        },
        jump: {
            imageSrc: '/static/assets/img/samuraiMack/Jump.png',
            maxFrames: 2,
        },
        fall: {
            imageSrc: '/static/assets/img/samuraiMack/Fall.png',
            maxFrames: 2,
        },
        death: {
            imageSrc: '/static/assets/img/samuraiMack/Death.png',
            maxFrames: 6,
        },
        attack1: {
            imageSrc: '/static/assets/img/samuraiMack/Attack1.png',
            maxFrames: 6,
        },
        takeHit: {
            imageSrc: '/static/assets/img/samuraiMack/Take hit White.png',
            maxFrames: 4,
        }
...
export const enemy = new Fighter({
    ...
    imageSrc: '/static/assets/img/kenji/Idle.png',
    scale: 2.5,
    maxFrames: 4,
    holdFrames: 6,
    ...
    sprites: {   // Sprites for different animations.
        ...
        run: {
            imageSrc: '/static/assets/img/kenji/Run.png',
            maxFrames: 8,
        },
        jump: {
            imageSrc: '/static/assets/img/kenji/Jump.png',
            maxFrames: 2,
        },
        fall: {
            imageSrc: '/static/assets/img/kenji/Fall.png',
            maxFrames: 2,
        },
        death: {
            imageSrc: '/static/assets/img/kenji/Death.png',
            maxFrames: 7,
        },
        attack1: {
            imageSrc: '/static/assets/img/kenji/Attack1.png',
            maxFrames: 4,
        },
        takeHit: {
            imageSrc: '/static/assets/img/kenji/Take hit white.png',
            maxFrames: 3,
        }
    },
    keys: {
