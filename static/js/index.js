...
import { initializeMotionDetection } from './motion-detection.js'
...
// Removed Player vs Player functionality - only AI mode available
...
function determineWinner({ player, enemy, timerID }) {
    ...
    if (player.health === enemy.health) {
        ...
        document.querySelector('#result').innerHTML = 'AI won!'; // Enemy's health is greater.
        player.health = 0;
